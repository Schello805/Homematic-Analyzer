...
const notificationSettingsSchema = z.object({
  ...
  events: z.object({
    ...
    serviceSecurity: z.boolean().optional(),
    serviceHeating: z.boolean().optional(),
    serviceActuator: z.boolean().optional(),
    serviceTypes: z.array(z.string().max(120)).max(30).optional(),
